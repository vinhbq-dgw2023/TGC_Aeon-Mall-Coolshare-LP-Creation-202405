    ...
    "products" : [
        {
            ...
            new: '0' ,
            urlImg: '../assets/images/products/dummy.png',
            txtHeading: '冷感グッズで「涼」を感じよう！',
            date: '7月19日～8月15日',
            url: 'https://qualite-prix.jp/special/lists/winter2023',
            txtUrl: '',
            urlMall: 'https://qualite-prix.jp',
            txtDescription: '各店舗イチ押しの冷感グッズ・「涼」を感じられる商品が一同に展開されます。見て、聞いて、感じて「「涼」を体感してください！',
            sponsors: '',
            province: '北海道・東北エリア',
            district: '北海道',
            store: 'イオンカテプリ新さっぽろ',
        },
        {
            ...
            new: '0' ,
            urlImg: '../assets/images/products/dummy.png',
            txtHeading: '紫外線＆湿気対策特集',
            date: '6/1～6/30',
            url: '',
            txtUrl: '1階 コーエン前など',
            urlMall: 'https://akita-aeonmall.com/',
            txtDescription: '暑い夏を快適に過ごすためのグッズをご紹介！',
            sponsors: '',
            province: '北海道・東北エリア',
            district: '秋田県',
            store: 'イオンモール秋田',
        ...
        },
       {
            ...
            new: '0' ,
            urlImg: '../assets/images/products/dummy.png',
            txtHeading: 'Tシャツコレクション',
            date: '6月1日（土）～6月30日（日）',
            url: '',
            txtUrl: '1階 共用部通路',
            urlMall: 'https://www.aeon.jp/sc/shibata/',
            txtDescription: 'イオンモール東浦より厳選した夏のバラエティー豊かなTシャツコレクションを開催。見て涼しい、着て涼しいをお届けします！',
            sponsors: '',
            province: '中部エリア',
            district: '新潟県',
            store: 'イオンモール新発田',
       },
       {
            ...
            new: '0' ,
            urlImg: '../assets/images/products/dummy.png',
            txtHeading: '夏を快適に過ごしたいおすすめグッズ特集',
            date: '7/12～8/31',
            url: '',
            txtUrl: '',
            urlMall: 'https://www.aeon.jp/sc/niigataminami/',
            txtDescription: 'イオンモールKYOTOよりこの夏を快適に過ごせるおすすめの商品をご紹介します！',
            sponsors: '',
            province: '中部エリア',
            district: '新潟県',
            store: 'イオンモール新潟南',
       },
        {
            ...
            txtDescription: '20店舗参加の集合VP。レジャーと仕事、おうちの3つのコンセプトで展開！',
            sponsors: '',
            province: '関東エリア',
            district: '埼玉県',
            store: 'イオンモール川口',
       ...
       },
       {
            ...
            txtHeading: 'ひんやりグッズ特集',
            date: '6/5～7/31',
            url: 'https://kawaguchi-aeonmall.com/special/lists/attakaitem2024',
            txtUrl: 'HP特集',
            urlMall: 'https://kawaguchi-aeonmall.com/',
            txtDescription: 'お出かけも おうちでも ひんやり<br>暑い夏を快適に過ごそう！<br>『ひんやりグッズ』特集',
            sponsors: '',
            province: '関東エリア',
            district: '埼玉県',
            store: 'イオンモール川口',
       },
        {
            ...
            new: '0' ,
            urlImg: '../assets/images/products/dummy.png',
            txtHeading: 'サマーレジャーdeCool',
            date: '2024年6月1日(土)～7月31日(水)',
            url: '',
            txtUrl: '',
            urlMall: 'https://www.aeon.jp/sc/higashikurume/',
            txtDescription: '涼を感じるアイテムや、涼やかなファッションをご提案！イオンモール八幡東で夏を楽しんでください♪',
            sponsors: '',
            province: '関東エリア',
            district: '東京都',
            store: 'イオンモール東久留米',
        },
       {
            ...
            new: '0' ,
            urlImg: '../assets/images/products/dummy.png',
            txtHeading: 'お仕事・学校deCool',
            date: '2024年6月1日(土)～7月31日(水)',
            url: '',
            txtUrl: '各店',
            urlMall: 'https://hinode-aeonmall.com/',
            txtDescription: '快適な夏に活躍するアイテムをご紹介！<br>今年の夏をCoolに過ごしましょう。',
            sponsors: '',
            province: '関東エリア',
            district: '東京都',
            store: 'イオンモール日の出',
    ...
    "events" : [
        {
            ...
            new: '0' ,
            urlImg: '../assets/images/events/dummy.png',
    ...
    "gourmet" : [
        {
            ...
            new: '0' ,
            urlImg: '../assets/images/gourmet/dummy.png',
            txtHeading: '冬のあったか特集',
            date: '2024年07月03日 (金) - 2025年12月01日 (日)',
            url: 'https://qualite-prix.jp/special/lists/winter2023',
            txtUrl: '',
    ...
    "community" : [
        {
            ...
            new: '0' ,
            urlImg: '../assets/images/community/dummy.png',
...
function checkDate(item) {
    ...
    if(dataDate === 'in') {
        return ((today >= dayStart && today <= dayEndPlus) || isNaN(dayEnd) || (isNaN(dayEnd) && isNaN(dayStart))) ? true : false; 
...
function renderItemPickUp() {
    var slideItemPc = $(".pc .js_render_slider"),
        slideItemSp = $(".sp .js_render_slider");
    jQuery.each( modalData.slide, function( index, item ) {
        if(checkDate(item)) {
            var itemPc = `<div class="banner banner-01 swiper-slide pc">
            ...
            var itemSp = `<div class="banner banner-01 swiper-slide">
                            <a href="#modal01" data-href="#modal01" data-cate="slide" data-id="${index}" class="js-openPopup">
...
$(document).ready(function(){
    ...
    var swiper = new Swiper('.pc.slider-for', {
        slidesPerView: 5,
        centeredSlides: true,
        loop: true,
        arrow: true,
    ...
    var swiper01 = new Swiper('.sp.slider-for', {
        slidesPerView: 1.6,
        centeredSlides: true,
        loop: true,
        arrow: true,
        ...
        pagination: { el: '.swiper-pagination02' , clickable: true },
    })
